...
export class ProfileDetails extends Component {
    ...
    componentDidMount() {
        const {userId, getUserData} = this.props
        getUserData(userId)
    }
                        ...
                        <Row>
                            <Col md={12}>
                                <div className='avatar'>
                                    <Image src='https://iupac.org/wp-content/uploads/2018/05/default-avatar.png'
                                           roundedCircle
                            ...
                            <Col md={12} className='info-buttons'>
                                <OverlayTrigger trigger='click' placement='bottom' overlay={emailPopover}>
                                    <div className='circle-button'>
                                        <AiOutlineMail className='icon' color='#ffffff' size='1.5em'/>
                                    </div>
                                </OverlayTrigger>
                                <OverlayTrigger trigger='click' placement='bottom' overlay={phonePopover}>
                                    <div className='circle-button'>
                                        <AiOutlinePhone className='icon' color='#ffffff' size='1.5em'/>
                                    </div>
                                </OverlayTrigger>
                            </Col>
                        </Row>
